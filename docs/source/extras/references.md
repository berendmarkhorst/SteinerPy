...
- D. Rehfeldt, T. Koch, S. J. Maher (2019), *Reduction techniques for the prize collecting Steiner tree problem and the maximum-weight connected subgraph problem*, Networks 73(2), 206–233, [doi:10.1002/net.21857](https://doi.org/10.1002/net.21857) ([accepted manuscript](https://eprints.lancs.ac.uk/id/eprint/129080/1/PcMwReductions_Preprint.pdf)) — the broader PCSTP/RPCSTP/MWCSP reduction framework and the roadmap for later prize-aware reduction stages.
- C. W. Duin (1993), *Steiner's problem in graphs*, PhD thesis, University of Amsterdam, and T. Polzin & S. Vahdati Daneshmand (2001), *Improved algorithms for the Steiner problem in networks*, Discrete Applied Mathematics 112(1–3), 263–300, [doi:10.1016/S0166-218X(00)00319-X](https://doi.org/10.1016/S0166-218X(00)00319-X) — alternative-based reduction tests, the Nearest-Vertex / Short-Links contraction tests (Obs. 3.2/3.3 of the 1998 technical-report version) and the bound-based Voronoi-radius deletions (Obs. 3.5/3.6) (`steinerpy/graph_reducer.py`).
- C. W. Duin, A. Volgenant (1989), *Reduction tests for the Steiner problem in graphs*, Networks 19(5), 549–567, [doi:10.1002/net.3230190506](https://doi.org/10.1002/net.3230190506) — the classic reduction-test framework (degree tests, NTDk) underlying the implementations here.
...
- E. Uchoa, R. F. Werneck (2012), *Fast local search for Steiner trees in graphs*, ACM Journal of Experimental Algorithmics 17, Article 2.2, [doi:10.1145/2133803.2184448](https://doi.org/10.1145/2133803.2184448) — the opt-in vertex-elimination and key-path-exchange primal neighborhoods (`steinerpy/primal_heuristics.py`).
- D. Rehfeldt, T. Koch (2023), *Implications, conflicts, and reductions for Steiner trees*, Mathematical Programming 197(2), 903–966, [doi:10.1007/s10107-021-01757-5](https://doi.org/10.1007/s10107-021-01757-5) — the opt-in implied-profit shortest-path heuristic, Section 5.1.1 equations (28–29) (`steinerpy/primal_heuristics.py`).
